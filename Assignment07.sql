...
-- 2023-08-22,ADinkel,Started Assignment
-- 2023-08-23,ADinkel,Finished Assignment
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ADinkel')
	 Begin 
	  Alter Database [Assignment07DB_ADinkel] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ADinkel;
	 End
	Create Database Assignment07DB_ADinkel;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ADinkel;
...
CREATE VIEW vCategoryInventories
	...
	SELECT TOP 1000000000 
		...
		DATENAME(mm,vInventories.InventoryDate) + ', ' + DATENAME(yyyy,vInventories.InventoryDate) AS InventoryDate,
